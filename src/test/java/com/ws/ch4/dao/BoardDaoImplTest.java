...
public class BoardDaoImplTest {
    ...
    @Test
    public void deleteTest22() throws Exception{
        boardDao.delete(1733, "writer200");
        System.out.println("boardDao.select(1733) = " + boardDao.select(1733));
        assertTrue(boardDao.select(1733)==null);
    }
}